...
if __name__ == '__main__':
    ...
    # arguments
    parser = argparse.ArgumentParser(description = 'Update app permissions for a user. Permissions options are READ, WRITE, EXECUTE, READ_WRITE, READ_EXECUTE, WRITE_EXECUTE, ALL, or NONE.')
