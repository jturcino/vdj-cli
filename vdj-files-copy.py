...
if __name__ == '__main__':
    ...
    # arguments
    parser = argparse.ArgumentParser(description = 'Copy a projectfile or jobfile from one location on data.vdjserver.org to a projectfile destination. This command updates metadata, and the copied file will be visible on vdjserver.org.')
